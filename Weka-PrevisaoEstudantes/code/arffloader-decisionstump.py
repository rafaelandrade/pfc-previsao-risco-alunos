...
for i in range(5,36):
	data = arff.loadarff('/Users/rafaelandrade/Downloads/WekaFinal/data/results-decisionstump/situacao' + str(i) +'.arff')
...
plt.text(30 + 0.02,roc_auc[25] + 0.04, 'AUC = %0.4f' % roc_auc[30], fontsize = 10)
